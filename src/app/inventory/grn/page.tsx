...
import { Truck, Plus, Search, Loader2, X, Trash2 } from "lucide-react";
...
export default function GRNPage() {
  ...
  async function handleDelete() {
    if (!deleteId) return;
    setDeleting(true);
    try { await inventoryApi.deleteGRN(deleteId); setDeleteId(null); fetchAll(); }
      ...
      {deleteId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm mx-4 p-6">
            <h3 className="text-base font-semibold text-gray-900 mb-2">Delete GRN?</h3>
